            ...
            <div className="px-6 py-4 bg-white border-b border-gray-100 flex justify-between items-center shadow-sm z-10 shrink-0">
              <div className="flex items-center gap-3">
                <button 
                  ...
                  className="w-10 h-10 rounded-full bg-blue-50 text-cta flex items-center justify-center font-bold overflow-hidden hover:ring-2 hover:ring-blue-100 transition-all shrink-0"
                >
                ...
                <div className="min-w-0">
                  <div className="flex items-center gap-2">
                    <button 
                      onClick={handleProfileClick}
                      className="font-bold text-primary text-lg leading-tight truncate hover:text-cta transition-colors"
                    >
                      {otherUserNickname}
                    </button>
                    <span className="shrink-0 text-xs font-semibold text-emerald-500 bg-emerald-50 px-1.5 py-0.5 rounded-md">대화 중</span>
                  </div>
                  {otherUser && (
